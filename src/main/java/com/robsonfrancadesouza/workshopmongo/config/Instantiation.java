...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("20/07/2024"),  "Partiu viagem", "Vou viajar para Sao Paulo. Abraços!", maria);
		Post post2 = new Post(null, sdf.parse("21/07/2024"),  "Bom dia", "Acordei feliz hoje!", maria);
