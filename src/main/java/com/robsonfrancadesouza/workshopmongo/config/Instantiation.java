package com.robsonfrancadesouza.workshopmongo.config;
...
import com.robsonfrancadesouza.workshopmongo.dto.AuthorDTO;
import com.robsonfrancadesouza.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("20/07/2024"),  "Partiu viagem", "Vou viajar para Sao Paulo. Abraços!", new AuthorDTO( maria));
		Post post2 = new Post(null, sdf.parse("21/07/2024"),  "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
